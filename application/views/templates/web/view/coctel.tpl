                            ...
                            <table class="table table-bordered table-hover example-table" style="text-align: center">
                                ...
                                {foreach $lista as $l}
                                        <tr class="resultado">
                                            ...
                                            <td>
                                                {if $l.asistio == '1'}
                                                    <a class="btn btn-success b_marcar_no_asistencia" data-id="{$l.idcoctel}" data-estado="{$l.asistio}">ASISTIO</a>
                                                    <a class="btn btn-success b_coctel_acomp">marcar con acompañante</a>
                                                {else}
                                                    <a class="btn btn-danger b_marcar_asistencia" data-id="{$l.idcoctel}" data-estado="{$l.asistio}">marcar asistencia</a>
                                                    <a class="btn btn-success b_coctel_acomp">marcar con acompañante</a>
                                                {/if}
