<div class="content-wrapper">
    <section class="content-header">
        <ol class="breadcrumb" style="margin-bottom: 10px">
            ...
            <li class="active"><a href="{$base_url}admin/convenio/listar"><i class="fa fa-list"></i> Listado de Convenios</a></li>
        </ol>
        <a data-url="{$base_url}admin/convenio/agregar" class="btn btn-social btn-success m-add"><i class="fa fa-plus"></i> Nuevo</a>
    </section>
                            ...
                            <table class="table table-bordered table-hover example-table" style="text-align: center">
                                ...
                                {foreach $lista as $l}
                                        <tr class="resultado">
                                            <td>{$l.numero}</td>
                                            <td>
                                                <img src="{$base_url}public/imagen/convenio/{$l.imagen}" style="width:100px; height:50px; ">
                                            </td>
                                            <td>{$l.nombre}</td>
                                            <td>{$l.posicion}</td>
                                            <td>{$l.accion}</td>
