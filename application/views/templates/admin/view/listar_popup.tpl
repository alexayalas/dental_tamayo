<div class="content-wrapper">
    <section class="content-header" style="margin-bottom: 20px">
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{$base_url}admin/popup/listar"><i class="fa fa-list"></i> Listado de Popup</a></li>
        </ol>
        <!--<a data-url="{$base_url}admin/popup/agregar" class="btn btn-social btn-success m-add"><i class="fa fa-plus"></i> Nuevo</a>-->
    </section>
                            ...
                            <table class="table table-bordered table-hover example-table" style="text-align: center">
                                ...
                                {foreach $lista as $l}
                                        <tr class="resultado">
                                            <td>{$l.numero}</td>
                                            <td>
                                                <img src="{$base_url}public/imagen/popup/{$l.imagen}" style="width:100px; height:100px; ">
                                            </td>
                                            <td>{$l.titulo}</td>
                                            <td>{$l.url}</td>
                                            <td>{$l.f_vencimiento}</td>
                                            <td>{$l.accion}</td>
                                        </tr>                                       
                                {/foreach}
                                {/if}
