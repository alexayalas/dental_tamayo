<div class="content-wrapper">
    <section class="content-header">
        <ol class="breadcrumb" style="margin-bottom: 10px">
            ...
            <li class="active"><a href="{$base_url}admin/especialidad/listar"><i class="fa fa-list"></i> Listado de Especialidades</a></li>
        </ol>
        <a data-url="{$base_url}admin/especialidad/agregar" class="btn btn-social btn-success m-add"><i class="fa fa-plus"></i> Nuevo</a>
    </section>
