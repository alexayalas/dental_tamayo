<div class="content-wrapper">
    <section class="content-header">
        <ol class="breadcrumb" style="margin-bottom: 10px">
            ...
            <li class="active"><a href="{$base_url}admin/slider/listar"><i class="fa fa-list"></i> Slider</a></li>
        </ol>
        <a href="{$base_url}admin/slider/agregar" class="btn btn-social btn-success"><i class="fa fa-plus"></i> Nuevo</a>
    </section>
                            ...
                            <table class="table table-bordered table-hover example-table" style="text-align: center">
                                ...
                                {foreach $lista as $l}
                                        <tr class="resultado">
                                            <td>{$l.numero}</td>
                                            <td>
                                                <img src="{$base_url}public/imagen/slider/{$l.imagen}" style="width:100px; height:50px; ">
                                            </td>
                                            <td>{$l.titulo}</td>
                                            <td>{$l.subtitulo}</td>
                                            <td>{$l.f_registro}</td>
