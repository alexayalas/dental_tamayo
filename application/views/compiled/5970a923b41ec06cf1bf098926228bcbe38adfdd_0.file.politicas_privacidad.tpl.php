<?php /* Smarty version 3.1.27, created on 2018-07-16 12:32:32
         compiled from "/var/www/vhosts/multident.pe/httpdocs/application/views/templates/web/view/politicas_privacidad.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:18398120035b4cd6b0f180c0_77631741%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5970a923b41ec06cf1bf098926228bcbe38adfdd' => 
    array (
      0 => '/var/www/vhosts/multident.pe/httpdocs/application/views/templates/web/view/politicas_privacidad.tpl',
      1 => 1531762320,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18398120035b4cd6b0f180c0_77631741',
  'variables' => 
  array (
    'base_url' => 0,
  ),
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5b4cd6b1011fb7_84292711',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5b4cd6b1011fb7_84292711')) {
function content_5b4cd6b1011fb7_84292711 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '18398120035b4cd6b0f180c0_77631741';
?>
<style>
    .ppolitica{
        text-align: justify;
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-7 ">
                <h1 class="entry-title">Políticas de Protección de la Privacidad</h1>
                <nav class="bread-crumb">
                    <ul class="breadcrumb clearfix"><li><a href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
">Multident</a><span class="divider"></span></li><li class="active">Políticas de Protección de la Privacidad</li></ul>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="blog-page-single clearfix">
                    <article class="clearfix post-253 page type-page status-publish hentry">
                            ...
                            <div class="entry-content" itemprop="text">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <p class="ppolitica">MULTIDENT está altamente comprometido en mantener su información segura y para ello constantemente nos aseguramos que no exista ningún acceso no autorizado.</p>


                                        <h3 class="h3">4. Uso de la información recogida</h3>
                                        <p class="ppolitica">Usted autoriza expresamente a MULTIDENT, incorporar su información al banco de Datos Personales de Pacientes, para fines administrativos y de gestión comercial.</p>

                                        <p class="ppolitica">Los formularios de nuestra página web han sido creados con la única finalidad de solicitar información para los siguientes fines:</p>
                                        ...
                                        <p class="ppolitica">Considerando los fines descritos, usted otorga su consentimiento de manera indefinida. Si no está de acuerdo con el tratamiento posterior de su información, usted podrá revocar la presente autorización y proceder de acuerdo a lo indicado en el punto 5.</p>


                                        <h3 class="h3">5. Ejercicio de sus derechos como titular de datos personales</h3>
                                        <p class="ppolitica">En el momento que Usted considere conveniente, puede revocar su consentimiento o ejercer sus derechos que como titular de datos personales le asisten (acceso, rectificación, cancelación, oposición, información o revocación), de manera gratuita y sólo de la información que proporcionó y en la base de datos que corresponda: Citas en línea, Franquicia o Multident News.</p>

                                        <p class="ppolitica">Para tal efecto, usted puede apersonarse a nuestro local principal cito en Jr. Medrano Silva 401, Barranco, Lima, Perú y preguntar por el encargado del área de Soporte y Sistemas o también puede enviar un mensaje a la cuenta de correo electrónica <a href="mailto:protecciondedatos@multident.pe" style="text-decoration: underline;">protecciondedatos@multident.pe</a>, indicando lo siguiente:</p>
                                        <ul>
